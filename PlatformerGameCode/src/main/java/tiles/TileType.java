...
public enum TileType {
 //TODO: these should all be unique colors
    ...
    TELEPORTER_BLUE(new Color(128,51,0)),
    TELEPORTER_CYAN(new Color(128,51,0)),
    TELEPORTER_GRAY(new Color(128,51,0)),
    TELEPORTER_GREEN(new Color(128,51,0)),
    TELEPORTER_PURPLE(new Color(128,51,0)),
    TELEPORTER_RED(new Color(128,51,0)),
    TELEPORTER_YELLOW(new Color(128,51,0)),

    BUTTON_ON_CYAN_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_CYAN(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_MAGENTA_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_MAGENTA(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_RED_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_RED(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_WHITE_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_WHITE(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_YELLOW_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_YELLOW(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_LIME_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_LIME(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_BROWN_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_BROWN(new Color(0,212,255),new Animation(79, 0, 1f, 1)),

    BUTTON_ON_BLUE_CIRC(new Color(0,201,255),new Animation(1, 0, 0.5f, 0.1f)),
    GATE_BLUE(new Color(0,212,255),new Animation(79, 0, 1f, 1)),
